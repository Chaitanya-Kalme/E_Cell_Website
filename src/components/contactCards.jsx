...
const contactCards = ({ member }) => {
  ...
  return (
    <div className="relative w-54 h-64 bg-white dark:bg-gray-800 border-4 border-blue-700 dark:border-orange-200 rounded-lg overflow-hidden group cursor-pointer transition-all duration-300 hover:shadow-2xl mx-4 my-6">
      ...
      <div className="flex flex-col items-center justify-center h-full p-6 group-hover:opacity-0 transition-opacity duration-300">
        ...
        <p className="text-blue-600 dark:text-orange-300 text-center font-medium">{position}</p>
      </div>
