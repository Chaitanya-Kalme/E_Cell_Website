...
export default function NavBar() {
  ...
  return (
    <div className="w-full bg-gray-800 fixed top-0 left-0 right-0 z-50 text-lg">
      <NavigationMenu
        viewport={false}
        className="flex items-center justify-between text-white px-4 py-3 max-w-screen-xl mx-auto"
      >
        {/* Left side: Image */}
        ...
        <NavigationMenuList className="gap-x-6 hidden md:flex dark:text-white">
          <NavigationMenuItem>
            <Link href="/E-Summit" className="hover:text-gray-300">
              Home
            </Link>
          </NavigationMenuItem>
          <NavigationMenuItem>
            <Link href="/E-Summit/events" className="hover:text-gray-300">
              Events
            </Link>
          </NavigationMenuItem>
          <NavigationMenuItem>
            <Link href="/E-Summit/team" className="hover:text-gray-300">
              Our Team
            </Link>
          </NavigationMenuItem>
          <NavigationMenuItem>
            <Link href="/E-Summit/contact" className="hover:text-gray-300">
              Contact Us
            </Link>
          </NavigationMenuItem>
          <NavigationMenuItem>
            <Link href="/E-Summit/StartUpExpo" className="hover:text-gray-300">
              StartUp Expo
            </Link>
          </NavigationMenuItem>
          <NavigationMenuItem>
          ...
          {session ? (
            <div className="space-x-2 md:flex text-white">
              ...
              <Link
                ...
                className="rounded-md p-1 px-2 bg-gray-800 hover:bg-blue-300"
              >
                Profile
              </Link>
              ...
              <Button
                onClick={() => Logout()}
                className="rounded-md bg-gray-800 hover:bg-blue-300 dark:text-white"
              >
                Logout
                <div>
                  <LogOut />
        ...
        <DropdownMenu open={open} onOpenChange={setOpen}>
          ...
          <DropdownMenuContent align="start" className="mt-6 ml-auto md:hidden">
            <DropdownMenuItem onClick={() => handleNavigate("/E-Summit")}>
              Home
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => handleNavigate("/E-Summit/team")}>
              Our Team
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem
